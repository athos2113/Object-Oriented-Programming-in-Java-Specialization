...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			String inputCharacters = getStringFromFile(textfile, numToCheck);

			long startTime = System.nanoTime();
			for(int i = 0 ; i < trials; i++){
				BasicDocument basic = new BasicDocument(inputCharacters);
			...
			for(int i = 0 ; i < trials; i++){
				EfficientDocument efficient = new EfficientDocument(inputCharacters);
