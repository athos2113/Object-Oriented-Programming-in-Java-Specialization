...
public class EarthquakeCityMap extends PApplet {
	...
	public void CheckEarthquakeForClick() {
		if(lastClicked != null) {
			return;
		}
		...
		for(Marker m : quakeMarkers) {
			...
			if(!marker.isHidden() && marker.isInside(map, mouseX, mouseY)) {
				...
				//Only display those earthquake Markers that are in close proximity to a city
	...
	public void CheckCityForClick() {
		...
		for(Marker marker : cityMarkers) {
			if(!marker.isHidden() && marker.isInside(map, mouseX, mouseY)) {
				...
				for(Marker mhide : quakeMarkers) {
					module5.EarthquakeMarker quakeMarker = (module5.EarthquakeMarker)mhide;
